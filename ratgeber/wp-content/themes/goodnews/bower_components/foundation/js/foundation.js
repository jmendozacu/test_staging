  ...
  Foundation.libs.topbar = {
    ...
    events : function (bar) {
      ...
      S(this.scope)
        ...
        .on('click.fndtn.topbar','.top-bar:not(.has-ubermenu-mobile) .top-bar-section li a[href^="#"],[' + this.attr_name() + ']:not(.has-ubermenu-mobile) .top-bar-section li a[href^="#"]',function (e) {
