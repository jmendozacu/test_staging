        ...
        */
        ...
        protected function magento_get_customer($parties) {
            ...
            foreach ( array('invoice' => 'billingaddress',
				...
				$adress_remark = $current_address->get_address_remarks(); // hinzugefügt MM 01.04.2016 ->  Array! address_remark[$type] = $value;
                ...
                $customer[$addresstype] = array(
					...
					'prefix' => $current_address->get_contact_details()->get_title(),  //  female/male hinzugefügt MM 01.04.2016 					
					'suffix' => $adress_remark['address'],   	// Adress-Zusatz hinzugefügt MM 01.04.2016 
