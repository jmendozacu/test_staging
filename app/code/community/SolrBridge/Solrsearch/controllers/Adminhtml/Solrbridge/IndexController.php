 ...
 */
class SolrBridge_Solrsearch_Adminhtml_Solrbridge_IndexController extends Mage_Adminhtml_Controller_Action {
    ...
    public function saveAction() {
    	...
    	if ($index && $index->getStoreId() == $indexData['store_id']) {
    	    ...
    	    $this->getResponse()->setRedirect($this->getUrl('adminhtml/solrbridge_index/index'));
    	    return $this;
    	}
