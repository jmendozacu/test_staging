 ...
 * @subpackage  Flagbit_Mip
 */
class Flagbit_Mip_Block_System_Manager_Tab_Modules extends Mage_Adminhtml_Block_System_Config_Form
{
    ...
    protected function _initObjects()
    {
        ...
        $this->_configData = Mage::getModel('mip/submodule_config_data')
            ->setSection($this->getSectionCode())
            ->setWebsite($this->getWebsiteCode())
            ->setStore($this->getStoreCode())
            ->load();

        $this->_configFields = Mage::getSingleton('mip/submodule_config');
