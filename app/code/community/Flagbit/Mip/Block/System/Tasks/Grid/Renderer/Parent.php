 ...
 */
class Flagbit_Mip_Block_System_Tasks_Grid_Renderer_Parent extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        return $this->_getCheckboxHtml($value, $checked).($value > 0 ? ' ('.$value.')' : '');
    }
